...
const Banner = () => {
  return (
    <>
      <div className="bg-slate-100 dark:bg-gray-800 dark:text-white  grid grid-cols-1 lg:grid-cols-2 items-center gap-5 rounded-md">
        {/* image */}
        ...
        <h2 className="text-xl md:text-2xl  font-bold">Bangladesh Cricket Team Is One Of The Best In The World.</h2>
